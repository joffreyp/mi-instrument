...
class FlcdrXMmpCdsParserUnitTestCase(ParserUnitTestCase):
    ...
    def test_simple(self):
        ...
        with open(os.path.join(RESOURCE_PATH, 'flcdr_1_20131124T005004_458.mpk'), 'rb') as stream_handle:
            ...
            self.assert_particles(particles[5:6], 'good_cdr.yml', RESOURCE_PATH)

            # this yml file only has particle 1 in it
            self.assert_particles(particles[1:2], 'second_cdr.yml', RESOURCE_PATH)

            # this yml file only has particle 0 in it
            self.assert_particles(particles[0:1], 'first_cdr.yml', RESOURCE_PATH)
    ...
    def test_get_many(self):
        ...
        with open(os.path.join(RESOURCE_PATH, 'flcdr_1_20131124T005004_458.mpk'), 'rb') as stream_handle:
            ...
            self.assert_particles(particles[19:20], 'get_many_one_cdr.yml', RESOURCE_PATH)
            ...
            self.assert_particles(particles[29:30], 'get_many_two_cdr.yml', RESOURCE_PATH)
    ...
    def test_long_stream(self):
        ...
        with open(os.path.join(RESOURCE_PATH, 'flcdr_concat.mpk'), 'rb') as stream_handle:
    ...
    def test_bad_data_one(self):
        ...
        with open(os.path.join(RESOURCE_PATH, 'flcdr_1_20131124T005004_458-BAD.mpk'), 'rb') as stream_handle:
