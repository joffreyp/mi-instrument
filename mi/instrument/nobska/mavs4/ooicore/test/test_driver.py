...
class Mavs4Mixin(DriverTestMixin):
    ...
    _driver_parameters = {
        ...
        InstrumentParameters.FREQUENCY: {TYPE: float, READONLY: False, DA: False, STARTUP: False},
        ...
        InstrumentParameters.BURST_INTERVAL_DAYS: {TYPE: int, READONLY: False, DA: False, STARTUP: False},
        InstrumentParameters.BURST_INTERVAL_HOURS: {TYPE: int, READONLY: False, DA: False, STARTUP: False},
        ...
        InstrumentParameters.WARM_UP_INTERVAL: {TYPE: str, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.THREE_AXIS_COMPASS: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.SOLID_STATE_TILT: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.THERMISTOR: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.PRESSURE: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.AUXILIARY_1: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.AUXILIARY_2: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
        InstrumentParameters.AUXILIARY_3: {TYPE: bool, READONLY: True, DA: False, STARTUP: False},
    ...
    parameter_values = {
        ...
        InstrumentParameters.MONITOR: True,
        InstrumentParameters.LOG_DISPLAY_ACOUSTIC_AXIS_VELOCITIES: True,
        InstrumentParameters.LOG_DISPLAY_ACOUSTIC_AXIS_VELOCITIES_FORMAT: 'SI',
    ...
    _status_parameters = {
        Mavs4StatusDataParticleKey.VELOCITY_OFFSET_PATH_A: {TYPE: int, VALUE: -571},
        ...
        Mavs4StatusDataParticleKey.VELOCITY_OFFSET_PATH_D: {TYPE: int, VALUE: 768},
    ...
    _status_instrument_parameters = {
        InstrumentParameters.VELOCITY_OFFSET_PATH_A: {TYPE: int, VALUE: -571},
        ...
        InstrumentParameters.VELOCITY_OFFSET_PATH_D: {TYPE: int, VALUE: 768},
    ...
    _sample_parameters = {
        ...
        Mavs4SampleDataParticleKey.ACOUSTIC_AXIS_VELOCITY_D: {TYPE: int, VALUE: -116},
    ...
    STATUS_PARTICLE = {"driver_timestamp": 3575990156.890163,
                       ...
                       "values": [{"value": 6, "value_id": "compass_offset_1"},
                                  ...
                                  {"value": 768, "value_id": "velocity_offset_d"},
                                  ...
                                  {"value": -3328, "value_id": "velocity_offset_a"}]
    }
...
class Testmavs4_UNIT(InstrumentDriverUnitTestCase, Mavs4Mixin):
    ...
    def test_capabilities(self):
        ...
        capabilities = {
            ...
            ProtocolStates.AUTOSAMPLE: [ProtocolEvent.GET,
...
class Testmavs4_INT(InstrumentDriverIntegrationTestCase, Mavs4Mixin):
    ...
    def test_polled_particle_generation(self):
        ...
        self.assert_particle_generation(ProtocolEvent.ACQUIRE_STATUS, DataParticleType.STATUS,
                                        self.assert_particle_status, delay=20)
