...
class UtilMixin(DriverTestMixin):
    ...
    ###
    _driver_parameters = {
        InstrumentParameters.IDENTIFICATION : {TYPE: str, READONLY: True, DA: False, STARTUP: False, VALUE: 'RBR XR-420 6.810 021964'},
    ...
    _engineering_parameters = {
        ...
        XR_420EngineeringDataParticleKey.CALIBRATION_COEFFICIENTS: {
            ...
            VALUE: [
                ...
                [0.00352734558932672, -0.000250806607039791, 2.52981232225823e-06, -6.9681632181742e-08],
                [0.00352908906242572, -0.000251527366676445, 2.55498317829155e-06, -7.22727455164041e-08],
                [0.0035106579008714, -0.000251451725838218, 2.51618864926975e-06, -6.37003888154981e-08],
                [0.00352043330655908, -0.000251319883389552, 2.52146924964957e-06, -7.95333725252667e-08],
                [0.00347203853074575, -0.000250010390734016, 2.46129147793677e-06, -7.12959689441277e-08],
                [0.00353004946255691, -0.000251247554226747, 2.52159304090808e-06, -7.79481130920587e-08],
                [0.00351399903159413, -0.000251445570503529, 2.50096227037833e-06, -7.60943129358672e-08],
                ...
                [0.00349025189639767, -0.000250309161843678, 2.5055791623668e-06, -7.25120915816188e-08],
                [0.00353877751299455, -0.000251807379744552, 2.55602860165318e-06, -6.5251264076325e-08],
                [0.00352973393792469, -0.000252011191704782, 2.54873468118718e-06, -6.14820327594475e-08],
                [0.00352310007997345, -0.000251300883481298, 2.52824482619229e-06, -6.74465833408085e-08],
                [0.00350603632611762, -0.000250897867392207, 2.54479746316057e-06, -7.41559532076147e-08],
                [0.00351995561219995, -0.000251784157910044, 2.56187105314808e-06, -6.56020154220122e-08],
                [0.00348834955133481, -0.00024929110242942, 2.76692656687453e-06, -6.84152614194907e-08],
                [0.00349851973435787, -0.000251264850202629, 2.47592261180165e-06, -6.64877670276299e-08]
            ]
        }
    }
...
class TestQUAL(InstrumentDriverQualificationTestCase, UtilMixin):
    ...
    def test_direct_access_telnet_mode(self):
        ...
        self.assertTrue(self.tcp_client.expect("RBR XR-420 6.810 021964"))

        self.assert_direct_access_stop_telnet()

    def test_direct_access_exit_from_autosample(self):
        """
        Test that we can connect to the instrument via direct access, then exit
        after the instrument goes into autosample mode.
        """
        self.assert_enter_command_mode()
