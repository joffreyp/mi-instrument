...
"</StatusData>" + NEWLINE
    ...
    _configuration_parameters = {
        ...
        SBE19ConfigurationParticleKey.EXT_VOLT_2: {TYPE: int, VALUE: False, REQUIRED: True},
        SBE19ConfigurationParticleKey.EXT_VOLT_3: {TYPE: int, VALUE: False, REQUIRED: True},
        SBE19ConfigurationParticleKey.EXT_VOLT_4: {TYPE: int, VALUE: False, REQUIRED: True},
        SBE19ConfigurationParticleKey.EXT_VOLT_5: {TYPE: int, VALUE: False, REQUIRED: True},
        ...
        SBE19ConfigurationParticleKey.OPTODE: {TYPE: int, VALUE: 0, REQUIRED: True},
