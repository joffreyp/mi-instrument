...
class ADCPTMixin(DriverTestMixin):
    ...
    _calibration_data_parameters = {
        AdcpCompassCalibrationKey.FLUXGATE_CALIBRATION_TIMESTAMP: {'type': float, 'value': 1347614732.0},
        ...
        AdcpCompassCalibrationKey.TILT_CALIBRATION_TIMESTAMP: {'type': float, 'value': 1347614085.0},
    ...
    _pd0_config_parameters = {
        ...
        AdcpPd0ParsedKey.SYSCONFIG_VERTICAL_ORIENTATION: {'type': int, 'value': 1},
        AdcpPd0ParsedKey.SYSCONFIG_BEAM_ANGLE: {'type': int, 'value': 1},
        AdcpPd0ParsedKey.SYSCONFIG_BEAM_CONFIG: {'type': int, 'value': 4},
        ...
        AdcpPd0ParsedKey.SENSOR_AVAILABLE_SPEED: {'type': int, 'value': 0},
    ...
    def assert_particle_pd0_data_earth(self, data_particle, verify_values=False):
        """
        Verify an adcpt pd0 data particle
        @param data_particle: data particle
        @param verify_values: bool, should we verify parameter values
        """
