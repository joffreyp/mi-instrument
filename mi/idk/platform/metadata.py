...
"""
@file coi-services/mi/idk/platform/metadata.py
@author Bill French
...
class Metadata(mi.idk.metadata.Metadata):
    ...
    def relative_driver_path(self):
        ...
        """
        return os.path.join("mi", "platform", "driver",
                            self.driver_path)
    ...
    def current_metadata_path(self):
        ...
        """
        return self.idk_dir() + "/current_platform.yml"
    ...
    def _generate_versioned_metadata(self):
        ...
        """
        self.driver_name_versioned = 'platform_%s_%s' % (self.driver_name,
                                                    self.version.replace('.','_').replace('-','_'))
        self.entry_point_group = 'drivers.platform.%s' % self.driver_name
        # This assumes the name of the driver file is 'driver.py'
        self.versioned_constructor = 'driver-%s = %s.mi.platform.driver.%s.driver:%s' % (self.version,
